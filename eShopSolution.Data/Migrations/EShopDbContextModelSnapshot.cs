            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("ffd69b07-8224-4977-9894-c01049322f2f"), ConcurrencyStamp = "7cea9414-e9c2-4842-a30a-a54ec3b3c567", Description = "Administrator role", Name = "admin", NormalizedName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("e2903f00-4c67-4547-8c53-a29cc0715437"), AccessFailedCount = 0, ConcurrencyStamp = "5e7194a8-d0bd-4211-b9e4-4bc697753142", Dob = new DateTime(2000, 7, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "qtran0835@gmail.com", EmailConfirmed = true, FirstName = "Huu", LastName = "Quyen", LockoutEnabled = false, NormalizedEmail = "qtran0835@gmail.com", NormalizedUserName = "admin", PasswordHash = "AQAAAAEAACcQAAAAEA6ymPiKhF+Fs8rC2p4v3ErnDekmvoyL+NfcYJS0JzSn/vLiSf/7nsNda1+sS5a6zg==", PhoneNumberConfirmed = false, SecurityStamp = "", TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DateCreated = new DateTime(2022, 10, 15, 23, 52, 35, 649, DateTimeKind.Local), OriginalPrice = 100000m, Price = 200000m, Stock = 0, ViewCount = 0 }
                    );
                });
